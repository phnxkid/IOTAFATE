...
import 'notif_message_appel_sett_model.dart';
export 'notif_message_appel_sett_model.dart';

class NotifMessageAppelSettWidget extends StatefulWidget {
  const NotifMessageAppelSettWidget({Key? key}) : super(key: key);

  @override
  _NotifMessageAppelSettWidgetState createState() =>
      _NotifMessageAppelSettWidgetState();
}

class _NotifMessageAppelSettWidgetState
    extends State<NotifMessageAppelSettWidget> {
  late NotifMessageAppelSettModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotifMessageAppelSettModel());
                            ...
                            Row(
                              ...
                              children: [
                                FlutterFlowRadioButton(
                                  ...
                                  onChanged: (val) => setState(() {}),
                                  controller:
                                      _model.radioButtonValueController21 ??=
                                          FormFieldController<String>(null),
                                  optionHeight: 25.0,
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
                            ...
                            Row(
                              ...
                              children: [
                                FlutterFlowRadioButton(
                                  ...
                                  onChanged: (val) => setState(() {}),
                                  controller:
                                      _model.radioButtonValueController22 ??=
                                          FormFieldController<String>(null),
                                  optionHeight: 25.0,
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
                            ...
                            Row(
                              ...
                              children: [
                                FlutterFlowRadioButton(
                                  ...
                                  onChanged: (val) => setState(() {}),
                                  controller:
                                      _model.radioButtonValueController23 ??=
                                          FormFieldController<String>(null),
                                  optionHeight: 25.0,
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
                            ...
                            Row(
                              ...
                              children: [
                                FlutterFlowRadioButton(
                                  ...
                                  onChanged: (val) => setState(() {}),
                                  controller:
                                      _model.radioButtonValueController24 ??=
                                          FormFieldController<String>(null),
                                  optionHeight: 25.0,
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
