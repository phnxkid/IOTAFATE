...
import 'notif_iotafate_model.dart';
export 'notif_iotafate_model.dart';

class NotifIotafateWidget extends StatefulWidget {
  const NotifIotafateWidget({Key? key}) : super(key: key);

  @override
  _NotifIotafateWidgetState createState() => _NotifIotafateWidgetState();
}

class _NotifIotafateWidgetState extends State<NotifIotafateWidget> {
  late NotifIotafateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotifIotafateModel());
