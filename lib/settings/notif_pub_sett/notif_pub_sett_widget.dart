...
import 'notif_pub_sett_model.dart';
export 'notif_pub_sett_model.dart';

class NotifPubSettWidget extends StatefulWidget {
  const NotifPubSettWidget({Key? key}) : super(key: key);

  @override
  _NotifPubSettWidgetState createState() => _NotifPubSettWidgetState();
}

class _NotifPubSettWidgetState extends State<NotifPubSettWidget> {
  late NotifPubSettModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotifPubSettModel());
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    7.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  'Premières publications et stories',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Poppins',
