...
import 'notif_follow_sett_model.dart';
export 'notif_follow_sett_model.dart';

class NotifFollowSettWidget extends StatefulWidget {
  const NotifFollowSettWidget({Key? key}) : super(key: key);

  @override
  _NotifFollowSettWidgetState createState() => _NotifFollowSettWidgetState();
}

class _NotifFollowSettWidgetState extends State<NotifFollowSettWidget> {
  late NotifFollowSettModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotifFollowSettModel());
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Suivies, followers, et superabonnements',
              ...
              SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(40.0, 25.0, 30.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
