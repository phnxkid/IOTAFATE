...
import 'notif_collectes_model.dart';
export 'notif_collectes_model.dart';

class NotifCollectesWidget extends StatefulWidget {
  const NotifCollectesWidget({Key? key}) : super(key: key);

  @override
  _NotifCollectesWidgetState createState() => _NotifCollectesWidgetState();
}

class _NotifCollectesWidgetState extends State<NotifCollectesWidget> {
  late NotifCollectesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotifCollectesModel());
