...
import 'notif_direct_sett_model.dart';
export 'notif_direct_sett_model.dart';

class NotifDirectSettWidget extends StatefulWidget {
  const NotifDirectSettWidget({Key? key}) : super(key: key);

  @override
  _NotifDirectSettWidgetState createState() => _NotifDirectSettWidgetState();
}

class _NotifDirectSettWidgetState extends State<NotifDirectSettWidget> {
  late NotifDirectSettModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotifDirectSettModel());
