...
import 'notif_stories_publication_model.dart';
export 'notif_stories_publication_model.dart';

class NotifStoriesPublicationWidget extends StatefulWidget {
  const NotifStoriesPublicationWidget({Key? key}) : super(key: key);

  @override
  _NotifStoriesPublicationWidgetState createState() =>
      _NotifStoriesPublicationWidgetState();
}

class _NotifStoriesPublicationWidgetState
    extends State<NotifStoriesPublicationWidget> {
  late NotifStoriesPublicationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotifStoriesPublicationModel());
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Publication, stories et notifications',
