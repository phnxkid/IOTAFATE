...
import 'notif_commence_model.dart';
export 'notif_commence_model.dart';

class NotifCommenceWidget extends StatefulWidget {
  const NotifCommenceWidget({Key? key}) : super(key: key);

  @override
  _NotifCommenceWidgetState createState() => _NotifCommenceWidgetState();
}

class _NotifCommenceWidgetState extends State<NotifCommenceWidget> {
  late NotifCommenceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotifCommenceModel());
