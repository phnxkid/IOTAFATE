...
import 'contrat3_model.dart';
export 'contrat3_model.dart';

class Contrat3Widget extends StatefulWidget {
  const Contrat3Widget({Key? key}) : super(key: key);

  @override
  _Contrat3WidgetState createState() => _Contrat3WidgetState();
}

class _Contrat3WidgetState extends State<Contrat3Widget> {
  late Contrat3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Contrat3Model());
