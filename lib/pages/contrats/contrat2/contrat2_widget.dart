...
import 'contrat2_model.dart';
export 'contrat2_model.dart';

class Contrat2Widget extends StatefulWidget {
  const Contrat2Widget({Key? key}) : super(key: key);

  @override
  _Contrat2WidgetState createState() => _Contrat2WidgetState();
}

class _Contrat2WidgetState extends State<Contrat2Widget> {
  late Contrat2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Contrat2Model());
